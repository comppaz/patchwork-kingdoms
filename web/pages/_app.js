  ...
  return (
    ...
    >
      <Web3ReactProvider getLibrary={getLibrary}>
        <Head>
          <title>Patchwork Kingdoms | Raise funds to bring connectivity to schools across the globe | Giga x Snowcrash</title>
          <meta name="viewport" content="initial-scale=1.0, width=device-width" />

          <meta property="og:title" content="Patchwork Kingdoms | Giga x Snowcrash" />
          <meta property="og:site_name" content="Raise funds to bring reliable and robust connectivity to schools across the globe." />
          ...
          <meta name="twitter:description" content="Let's build a community of supporters for the Giga initiative and raise funds to bring reliable, robust connectivity to schools across the globe." />
