...
export default function News() {
    ...
    return (
        <div className="relative bg-gray-50 mt-6 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
            ...
            <div className="relative max-w-7xl mx-auto">
                <div className="text-center">
                    ...
                    <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">Learn more about the Patchwork Kingdoms project</p>
                </div>
                                ...
                                <a href={'/article/' + post.id} className="block mt-2">
                                    <div className="flex-shrink-0">
                                        <img
                                            ...
                                            src={post.attributes.FeaturedImage.data.attributes.formats.medium.url}
                                            alt=""
                                        />
                                    </div>
                                    <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                                        ...
                                        <div className="mt-6 flex items-center">
                                            <div className="ml-0">
                                                <p className="text-sm font-medium text-gray-900">{post.attributes.Author}</p>
