            ...
            <div className="bg-white">
                <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:px-8">
                    <p className="text-center text-sm font-light text-gray-500 tracking-wide">
                        <a className="text-teal-900 underline" target="_blank" href="https://gigaconnect.org/">Giga</a> (a UNICEF/ITU partnership) is developing this NFT collection in partnership with <a className="text-teal-900 underline" target="_blank" href="https://snowcrash.com/">Snowcrash Labs</a>.
                    </p>
                    ...
                    <div className="grid grid-cols-4 gap-2 md:grid-cols-8 lg:grid-cols-8">
                        {
                            partners.map((partner) => (
                                <div key={partner.alt} className="col-span-1 flex justify-center md:col-span-1 lg:col-span-1 py-4">
                                    <a target="_blank" href={partner.url}><img className="h-9" src={partner.imageUrl} alt={partner.alt} /></a>
                                </div>
                            ))
                        }
                        <div className="col-span-1 flex justify-center md:col-span-1 lg:col-span-1 py-4">
                            <a target="_blank" href="https://craft-clarity.com/"><img className="h-9" src="/images/partners/craft_clarity.png" alt="Craft Clarity Logo" /></a>
                        </div>
                        <div className="col-span-1 flex justify-center md:col-span-1 lg:col-span-1 py-4">
                            <a target="_blank" href="https://sagefdn.org/"><img className="h-9" src="/images/partners/sage.jpeg" alt="Sage Foundation Logo" /></a>
                        </div>
                    </div>
                </div>
            </div>
