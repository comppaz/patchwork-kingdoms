            ...
            <div className="relative pt-6">
                <Popover>
                            ...
                            <div className="hidden md:absolute md:space-x-10 md:flex md:justify-end md:right-0">
                                ...
                                {navigation.map(item => (
                                    <a
                                        ...
                                        href={item.href}
                                        target="_blank"
                                        className="inline-flex font-medium text-gray-500 hover:text-gray-900"
                                        rel="noreferrer">
                    ...
                    <Transition
                        ...
                        <Popover.Panel focus className="absolute top-2 pr-2 z-10 inset-x-0 transition transform origin-top-right md:hidden">
