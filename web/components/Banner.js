                    ...
                    <div className="flex items-center justify-between flex-wrap">
                        <div className="w-0 flex-1 flex items-center">
                            ...
                            <p className="ml-3 font-medium pr-1 text-white">
                                <span className="md:hidden">Our partners at <a href="https://snowcrash.com" className="underline" target="_blank">Snowcrash</a> have reserved <strong>100 founding membership tokens</strong> for you! </span>
                                <span className="hidden md:inline">To thank you for joining the Giga community, our partners at <a href="https://snowcrash.com" className="underline" target="_blank">Snowcrash</a> have reserved <strong>100 founding membership tokens</strong> for you! </span>
                            </p>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div className="mt-3 text-center sm:mt-5">
                                        <Dialog.Title as="h3" className="text-xl leading-6 font-medium text-gray-900">
                                            Apply to win one of <br />  <strong>100 Snowcrash founding <br /> membership tokens</strong>!
                                        </Dialog.Title>
                                        <div className="mt-4">
                                            <p className="text-sm">To be eligible to win one, you have to be on the Patchwork Kingdoms whitelist and complete this form!</p>
                                        </div>
                                        <div className="mt-8">
                                            <p className="text-lg tracking-wide">1. Connect to select your Ethereum wallet.</p>
                                            <button onClick={connect} className="py-2 mt-6 mb-4 text-sm text-gray-400 border border-gray-400 rounded-lg w-48 bg-white hover:bg-white px-12"><img src="/images/metamask.svg" width="125" /></button>
                                            <div className="-mt-2">
                                                {active ? <p className="text-xs">Connected with {account}</p> : <p className="text-xs">Not connected.</p>}
                                            </div>
                                            <div className="mt-8">
                                                <p className="text-lg tracking-wide">2. Tweet about the project <br />and tag <strong>@SnowcrashLabs</strong>.</p>
                                                <div className="py-2 mt-2 mb-4">
                                                    <div className="mt-2">
                                                        <a href={"https://twitter.com/intent/tweet?url=https%3A%2F%2Fpatchwork-kingdoms.com&text=I%E2%80%99m%20supporting%20Giga%20to%20help%20bring%20internet%20connectivity%20to%20schools%20around%20the%20world.%20%0A%0A@SnowcrashLabs,%20Giga%E2%80%99s%20creative%20partner%20on%20its%20inaugural%20NFT%20project,%20has%20reserved%20100%20membership%20tokens%20for%20the%20giga%20community.%20%0A%0ASign%20up%20for%20your%20chance%20to%20win%20one:"} target="_blank" className="py-2 mt-6 mb-4 text-sm text-gray-600 border border-gray-400 rounded-lg bg-white hover:bg-white px-12">
                                                            <svg className="w-6 inline-flex pr-2 -mt-1" role="img" fill="#1DA1F2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Twitter</title><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" /></svg>
                                                            Tweet now
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="mt-8">
                                                <p className="text-lg tracking-wide">3. Share your Twitter handle and <br /> your Solana wallet with us! </p>
                                                <div className="py-2 mt-2 mb-4">
                                                    <div className="mt-2">
                                                    ...
                                                    <div className="mt-2">
                                                        <div className="mt-1 flex rounded-md shadow-sm max-w-xs mx-auto">
                                                            ...
                                                            <input
                                                                ...
                                                                className="flex-1 min-w-0 block w-full px-3 py-2 rounded-none border rounded-r-md focus:ring-teal-500 focus:border-teal-500 sm:text-sm border-gray-300"
                                                                placeholder="2Ge..."
                                                                onChange={(e) => { handleSolana(e) }}
                                                            />

                                                        </div>
                                                        <p className="text-xs block max-w-xs mx-auto mt-2">If you are elected you'll receive your token on Solana.</p>
                                                    </div>
                                                    <div className="mt-4">
                                                        <label className="inline-flex items-left mt-3 max-w-xs">
                                                            <input type="checkbox" className="form-checkbox h-5 w-8 text-gray-600" onChange={(e) => { handleCheckbox(e) }} checked={check} /><span className="ml-2 text-sm text-left">By clicking on the button below, you acknowledge you have read and agree to be bound by Snowcrash, Inc.’s <a className="text-teal-900 underline" href="https://snowcrash.com/privacy" target="_blank">Privacy Policy</a> and <a className="text-teal-900 underline" href="https://snowcrash.com/terms" target="_blank">Terms of Use</a>.”</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                {error ? (
                                    <div className="rounded-md bg-red-50 p-4">
                                        <div className="flex">
                                            ...
                                            <div className="ml-3">
                                                <h3 className="text-sm font-medium text-red-800">We encountered an error with your submission</h3>
