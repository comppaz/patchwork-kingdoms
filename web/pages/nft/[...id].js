...
const generatePopup = (map, coordinates, properties) => {
  ...
  return (<>
    ...
    <div className="relative pt-4 bg-white overflow-hidden">
      ...
      {loading ? 
      <div className='fixed z-10 inset-1/2'>
        <svg role="status" className="relative mr-2 w-8 h-8 text-gray-400 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {loading ? null : <Slideover data={data} isDialogOpen={isDialogOpen} setDialogOpen={setDialogOpen}></Slideover>}  
    </>
  )
}
