          ...
          <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
            ...
            <div className="pt-12 sm:pt-16 lg:pt-20">
              ...
              <div className="mt-6 text-gray-500 space-y-6">
                <p className="text-lg">
                  We’ve partnered with data visualization scientist, designer and artist <strong className="tracking-wide">Nadieh Bremer</strong>. Bremer effectively ‘paints’ with data that <a className="text-teal-900 underline" target="_blank" href="https://gigaconnect.org/">Giga</a> has collected from schools themselves, creating a unique and visually striking collection of 1,000 NFTs called the Patchwork Kingdoms. These works are inspired by real information about school connectivity, which you can see on Giga's <a className="text-teal-900 underline" target="_blank" href="https://www.projectconnect.world">Project Connect</a> site.
              ...
              <dl className="grid grid-cols-2 gap-x-4 gap-y-8">
                {stats.map((stat) => (
                  <div key={stat.label} className="border-t-2 border-gray-100 pt-6">
                    ...
                    {stat.value === '1000' ? <small className="font-thin"> (1 reserved for artist - mint #1)</small> : null}
                  </div>
                ))}
              </dl>
              <div className="mt-10">
                <a onClick={(e) => { e.preventDefault(); setShowDetails(!showDetails) }} className="text-base font-medium text-teal-600 cursor-pointer">
                  {' '}
            ...
            <div className="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
              ...
              <div className="mt-8 lg:mt-0">
                <div className="mt-5 prose prose-indigo text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
                  <p>
                    Each kaleidoscopic square represents one school.
                    Square placement in the city represents connectivity.
                    The symbol within each square is chosen randomly.
                    The faster the speed, the more complex the symbol.

                  </p>
                  <p>
                    Each symbol has between 2-4 "complexity levels" with new elements added to each complexity level. For example, the slowest speeds might be a single circle, medium speeds get two concentric circles and the high speeds (but not in the top 10% of speeds) get three concentric circles.

                  </p>
                  <p>
                    When two schools with a fast speed have been algorithmically placed above one another, they, together, blossom into a full flower with a wreath of petals.

                    Two schools with fast internet placed side-by-side are configured to become a rainbow.
            ...
            <div className="relative lg:col-span-1">
              ...
              <blockquote className="mt-6 text-white">
                <p className="text-lg font-normal sm:text-2xl">
                  ...
                  This lack of connectivity means exclusion, marked by the lack of access to the wealth of information available online, fewer resources to learn and to grow, and limited opportunities for the most vulnerable children and youth to fulfill their potential.
                </p>
                <footer className="mt-6">
                  <p className="flex flex-col font-light">
                    <span>Giga, a collaboration between UNICEF and ITU, is working to connect every school in the world to the internet and give every young person access to information, opportunity, and choice.<br />

                    </span>
                    <span className="mt-1">
                      Giga <a className="underline" href="https://gigaconnect.org/scaling-ai-to-map-every-school-on-the-planet/" target="_blank">uses satellite imagery and machine learning</a> to map schools and their connectivity, new types of financing, including experimentations with cryptocurrencies, to help fund, and blockchain-based solutions to monitor and <a className="underline" target="_blank" href="https://www.weforum.org/agenda/2021/06/how-connectivity-credits-could-help-billions-get-online/">report on connectivity</a>.
                    </span>
                  </p>
                </footer>
              </blockquote>
