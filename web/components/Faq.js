...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'To buy a Patchwork Kingdom, you need a Metamask wallet. You can learn how to set up a Metamask wallet on <a class="underline" href="https://metamask.io/faqs.html" target="_blank">https://metamask.io/faqs.html</a> Once you have a wallet, you can use the ‘Mint’ button to connect your wallet and mint a token.<br><br>You need to be on the whitelist to have a chance to mint one of the tokens. If the list is oversubscribed, a random draw will be held to determine who can mint (see below).',
  },
  {
